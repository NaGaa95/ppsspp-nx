...
extern PFN_vkGetInstanceProcAddr g_ppssppLsfgGetInstanceProcAddr;
...
struct LsfgNxRuntime {
    explicit LsfgNxRuntime(const LsfgNxCreateInfo& info)
        ...
        g_ppssppLsfgGetInstanceProcAddr = info.get_instance_proc_addr;
        ...
        const lsfgvk::backend::BorrowedDevice borrowed{
            ...
            .pipelineCachePath = std::filesystem::path(
                "/switch/ppsspp-nx/cache/lsfg-vk-pipeline-cache.bin")
        };
